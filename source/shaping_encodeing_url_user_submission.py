...
def shaping_url_user_submission(userName, filename):
    ...
    with open('./shaping_encoding_URL/' + filename + '.csv', 'a', newline='') as f:
        writer = csv.writer(f)
        writer.writerow([userName, output])
